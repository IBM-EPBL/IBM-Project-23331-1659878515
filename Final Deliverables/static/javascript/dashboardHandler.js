...
fields.forEach(function(field){     //auto select value for fields where user has already provided the data
...
medform.addEventListener('submit', e => {   //listen for the submit action and validate empty fields (if any)
...
function selectDefault(field, c){   //auto select values for users who already provided the data
